...
def generate_arrays_from_file(lines,batch_size):
    ...
    while 1:
        ...
        Y_train = np_utils.to_categorical(np.array(Y_train),num_classes= 3)   
...
if __name__ == "__main__":
    ...
    with open("C:/学习/毕业设计/机器学习/Transfer-Learning-master/VGG16ForCatVSdog/data/train.txt","r") as f:
        lines = f.readlines()
